...
const Home: NextPage = () => {
    ...
    const settings = {
      customPaging: function(i) {
        return (
          <a>
            <img src={`/images/ichimaiita/example/yamazakura/slide-${i + 1}.jpg`} />
          </a>
        );
      },
      dots: true,
    ...
    return (
      ...
      <>
        <PageHead
          pageTitle = "山桜の一枚板"
          pageDescription = "山桜の一枚板"
          pagePath = "https://www.hidacolle.com/ichimaiita/yamazakura"
          pageImg = ""
          pageImgWidth = ""
          pageImgHeight = ""
        />
            ...
            <div className="item_images">
              ...
              <Slider {...settings}>
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/yamazakura/slide-1.jpg"
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/yamazakura/slide-2.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/yamazakura/slide-3.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/yamazakura/slide-4.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/yamazakura/slide-5.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/yamazakura/slide-6.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/yamazakura/slide-7.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/yamazakura/slide-8.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                {/* <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/yamazakura/slide-9.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/yamazakura/slide-10.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
              ...
              <table>
                <tbody>
                  ...
                  <tr className="table-size">
                    ...
                    <td className="table-line">2,080 × 900-1,030 × 53 (mm)</td>
                  </tr>
                  <tr className="table-numbering">
                    <th className="table-title">管理番号</th>
                    <td className="table-line">yz-23001</td>
                  </tr>
                </tbody>
              </table>
              <div className="price">790,000<span className="yen">円 (税込)</span></div>
