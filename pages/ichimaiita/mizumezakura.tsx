...
const Home: NextPage = () => {
    ...
    const settings = {
      customPaging: function(i) {
        return (
          <a>
            <img src={`/images/ichimaiita/example/mizumezakura/slide-${i + 1}.jpg`} />
          </a>
        );
      },
      dots: true,
    ...
    return (
      <>
        <PageHead
          pageTitle = "水目桜の一枚板"
          pageDescription = "水目桜の一枚板"
          pagePath = "https://www.hidacolle.com/ichimaiita/mizumezakura"
          pageImg = ""
          pageImgWidth = ""
          pageImgHeight = ""
        />
            ...
            <div className="item_images">
              ...
              <Slider {...settings}>
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/mizumezakura/slide-1.jpg"
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/mizumezakura/slide-2.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/mizumezakura/slide-3.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/mizumezakura/slide-4.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/mizumezakura/slide-5.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/mizumezakura/slide-6.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/mizumezakura/slide-7.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/mizumezakura/slide-8.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
                ...
                <div>
                  <Image
                    // loader={myLoader}
                    src="/images/ichimaiita/example/mizumezakura/slide-10.jpg"
                    alt="Picture of the author"
                    width={1280}
                    height={855}
                  />
              ...
              <table>
                <tbody>
                  ...
                  <tr className="table-size">
                    ...
                    <td className="table-line">2,200 × 650-800 × 55 (mm)</td>
                  </tr>
                  <tr className="table-numbering">
                    <th className="table-title">管理番号</th>
                    <td className="table-line">mz-23001</td>
                  </tr>
                </tbody>
              </table>
              <div className="price">385,000<span className="yen">円 (税込)</span></div>
