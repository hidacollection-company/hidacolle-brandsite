        ...
        return (
            <Html lang="ja">
                <Head>
                    ...
                    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@600&family=Poppins:wght@600&family=Noto+Sans+JP:wght@100..900&display=swap" rel="stylesheet"></link>
                </Head>
                <body>
