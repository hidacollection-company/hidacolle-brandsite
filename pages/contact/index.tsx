                    ...
                    {!isConfirm ? (
                        <>
                            <div className="introduction">
                                <h2>人の暮らしは「十人十色」</h2>
                                <p>
                                    みなさんそれぞれの暮らしの形は違っていますので、<br className="pc_only" />
                                    既製品の家具では、なかなかピッタリ納まることはないですよね。<br />
                                    また「テーブルをきれいにしたい」とか、<br />
                                    「使わなくなった一枚板、どうしよう・・・」などの<br className="pc_only" />
                                    お困りごともあります。
                                </p>
                                <p>
                                    お客様の声に耳を傾けながら、<br />
                                    既製品では見つからない家具を作らせていただき、<br className="pc_only" />またお客様のお困りごとを解決するご対応をしたいと思います。
                                </p>
                            </div>
