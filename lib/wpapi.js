...
export const wpClient = new WP({
    endpoint: `${process.env.WP_API_URL}/wp-json`,
});
...
// export async function getPreviewAllPostsTest(limit = 100) {
...
//     const query = `
//             query getPreviewAllPostsTest($limit: Int!) {
//                 posts(where: {status: DRAFT}, first: $limit) {
//                     edges {
//                         node {
//                             id
//                         }
...
//     } catch (err) {
//         console.log('~~ getPreviewAllPostsTest ~~')
//         console.log(err)
//     }
// }
